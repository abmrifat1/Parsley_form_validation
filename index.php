    ...
    <body>  
		   ...
		   <br>
			<div class="table-responsive">
				<h3 align="center">My Validation using Parsleys.js Library</h3><br />
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="password" name="password" id="password" required data-parsley-length="[8,16]" data-parsley-trigger="keyup" class="form-control">
								</div>
								<div class="form-group">
									<label>Confirm Password</label>
									<input type="password" type="confirm_password" required data-parsley-equalto="#password" data-parsley-trigger="keyup" name="confirm_password" id="confirm_password" required class="form-control">
								</div>
								<div class="form-group">
									<label>Website</label>
									<input type="text" name="website" id="website" required data-parsley-type="url"  data-parsley-trigger="keyup" class="form-control">
								</div>
								<div class="form-group">
								<div class="checkbox">
									<label>
							  			<input type="checkbox" name="check_rules" required id="check_rules" >I accept all terms and conditions</label>
								</div>
								<div class="form-group">
